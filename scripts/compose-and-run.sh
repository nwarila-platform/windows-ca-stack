...
#        COMPOSE_PLAYBOOK=<name>.yml to select a playbook under ansible/playbooks/ (default windows-ca-stack-aws.yml).
...
COMPOSE_PLAYBOOK_VALUE="${COMPOSE_PLAYBOOK-windows-ca-stack-aws.yml}"
